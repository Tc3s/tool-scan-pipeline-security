...
# Configure Matplotlib fonts and styles for perfect rendering
...
# --- CHART 1: LAPTOP CHART (FOR SECTION 2.1) ---
...
chart_laptop_path = 'docx_analysis_tools/chart_laptop_v5.png'
plt.savefig(chart_laptop_path, dpi=300, bbox_inches='tight', pad_inches=0.3)
plt.close()


# --- CHART 2: WEB SERVER CHART (FOR SECTION 2.2) ---
fig, ax = plt.subplots(figsize=(8.5, 4.5))
...
chart_web_path = 'docx_analysis_tools/chart_webserver_v5.png'
plt.savefig(chart_web_path, dpi=300, bbox_inches='tight', pad_inches=0.3)
plt.close()


# --- CUSTOM VIETNAMESE DETAILS DICTIONARY ---
VI_DETAILS = {
    # Laptop Findings
...
# Insert Chart 1 directly here as requested
...
# Insert Chart 2 directly here as requested
...
print("Successfully generated PERFECTION V5 Bao_Cao_An_Toan_Thong_Tin_2026.docx")
